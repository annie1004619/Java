...
public class ColorButtonFrame extends JFrame { // JFrame 상속
	...
	Color color[] = {Color.darkGray, Color.orange, Color.WHITE, Color.cyan,Color.black,Color.blue,Color.yellow,Color.green,Color.pink,Color.red};
	// ColorButtonFrame 생성자
	
	public ColorButtonFrame() {
		
	//	부모 생성자 호출, parameter : 학번 + 이름 + 클래스 이름;
	super("1711412 김지원 - ColorButtonFrame");
